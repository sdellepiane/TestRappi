...
public class Constants {
    ...
    public static final int CATEGORY_POPULAR_SELECTED = 1;
    public static final int CATEGORY_TOP_RATED_SELECTED = 2;
    public static final int CATEGORY_UPCOMING_SELECTED = 3;
